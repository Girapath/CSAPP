...
00000000004005e7 <main>:
  ...
  4005fc:	48 8d 3d f5 00 00 00 	lea    0xf5(%rip),%rdi        # 4006f8 <_IO_stdin_used+0x8>
  ...
  400634:	48 8d 3d e2 00 00 00 	lea    0xe2(%rip),%rdi        # 40071d <_IO_stdin_used+0x2d>
  ...
  40064b:	89 c7                	mov    %eax,%edi
  40064d:	e8 9e fe ff ff       	callq  4004f0 <sleep@plt>
  400652:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
  400656:	83 7d fc 09          	cmpl   $0x9,-0x4(%rbp)
  40065a:	7e bf                	jle    40061b <main+0x34>
  40065c:	e8 6f fe ff ff       	callq  4004d0 <getchar@plt>
